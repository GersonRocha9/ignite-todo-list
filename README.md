...
Projeto foi hospedado na Vercel. Acesse o **Ignite TodoList** desenvolvido [clicando aqui](https://todo-list-taupe-nu.vercel.app/).
...
```bash
git clone https://github.com/GersonRocha9/todo-list.git
```
